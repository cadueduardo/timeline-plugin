...
class TimelinePlugin {
    ...
    public function enqueue_scripts() {
        wp_enqueue_style('timeline-style', TIMELINE_PLUGIN_URL . 'assets/timeline.css', array(), '1.3.0');
        wp_enqueue_script('timeline-script', TIMELINE_PLUGIN_URL . 'assets/timeline.js', array('jquery'), '1.3.0', true);
